...
ax1.plot(plot_ster, plot_port, plot_X, "-", color="#00aa00", ms=4, mew=0.5, label = "Linearized")
...
ax2.plot(plot_port, plot_ster, plot_Y, "-", color="#00aa00", label = "Linearized", ms=4, mew=0.5)
