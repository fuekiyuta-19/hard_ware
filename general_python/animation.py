...
fig1 = plt.figure(figsize = (30.4, 9.6), dpi = 200, linewidth = 0, edgecolor = 'w')
...
def plot(data_x, len_lim, flag):
    ...
    ax_r.plot(data_x['time'].values, data_x['r'].values, label = ref, color = col)
...
def update(t):
    ...
    if t >= len(data1):
        ...
        ax1.plot(Y, X-7, color = "red", linestyle = "-", lw = 0.5)
        ...
        ax_r.plot(data1['time'].values[len(data1) - 1], data1['r'].values[len(data1) - 1], marker = 'o', color = "r", zorder = 10)
        ...
        ax_r.plot(data1['time'].values[t], data1['r'].values[t], marker = 'o', color = "r", zorder = 10)
    ...
    if t >= len(data2):
        ...
        ax1.plot(Y, X-3, color = "blue", linestyle = "-", lw = 0.5)
        ...
        ax_x.plot(data2['time'].values[len(data2) - 1], data2['X'].values[len(data2) - 1], marker = 'o', color = "r", zorder = 10)
        ax_x.axvline(x = data2['time'].values[len(data2) - 1], color = 'red', lw = 0.3)
        ax_u.plot(data2['time'].values[len(data2) - 1], data2['u'].values[len(data2) - 1], marker = 'o', color = "r", zorder = 10)
        ax_u.axvline(x = data2['time'].values[len(data2) - 1], color = 'red', lw = 0.3)
        ax_y.plot(data2['time'].values[len(data2) - 1], data2['Y'].values[len(data2) - 1], marker = 'o', color = "r", zorder = 10)
        ax_y.axvline(x = data2['time'].values[len(data2) - 1], color = 'red', lw = 0.3)
        ax_v.plot(data2['time'].values[len(data2) - 1], data2['vm'].values[len(data2) - 1], marker = 'o', color = "r", zorder = 10)
        ax_v.axvline(x = data2['time'].values[len(data2) - 1], color = 'red', lw = 0.3)
        ax_p.plot(data2['time'].values[len(data2) - 1], data2['psi'].values[len(data2) - 1], marker = 'o', color = "r", zorder = 10)
        ax_p.axvline(x = data2['time'].values[len(data2) - 1], color = 'red', lw = 0.3)
        ax_r.plot(data2['time'].values[len(data2) - 1], data2['r'].values[len(data2) - 1], marker = 'o', color = "r", zorder = 10)
        ax_r.axvline(x = data2['time'].values[len(data2) - 1], color = 'red', lw = 0.3)
        ...
        ax_x.plot(data2['time'].values[t], data2['X'].values[t], marker = 'o', color = "r", zorder = 10)
        ax_x.axvline(x = data2['time'].values[t], color = 'red', lw = 0.3)
        ax_u.plot(data2['time'].values[t], data2['u'].values[t], marker = 'o', color = "r", zorder = 10)
        ax_u.axvline(x = data2['time'].values[t], color = 'red', lw = 0.3)
        ax_y.plot(data2['time'].values[t], data2['Y'].values[t], marker = 'o', color = "r", zorder = 10)
        ax_y.axvline(x = data2['time'].values[t], color = 'red', lw = 0.3)
        ax_v.plot(data2['time'].values[t], data2['vm'].values[t], marker = 'o', color = "r", zorder = 10)
        ax_v.axvline(x = data2['time'].values[t], color = 'red', lw = 0.3)
        ax_p.plot(data2['time'].values[t], data2['psi'].values[t], marker = 'o', color = "r", zorder = 10)
        ax_p.axvline(x = data2['time'].values[t], color = 'red', lw = 0.3)
        ax_r.plot(data2['time'].values[t], data2['r'].values[t], marker = 'o', color = "r", zorder = 10)
        ax_r.axvline(x = data2['time'].values[t], color = 'red', lw = 0.3)
